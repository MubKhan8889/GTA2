...
@section('content')
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @else
                <h1 class="text-2xl font-bold text-gray-700 mb-4">Apprentice View</h1>
            @endif

                @if ($apprentices->isEmpty())
                    <p>No apprentices found.</p>
                @else
                @if (Auth::user()->role == "admin") <a href="{{ route('learners.create') }}" class="text-blue-500 hover:underline">Register Apprentice</a> @endif
                <div class="mb-4">
