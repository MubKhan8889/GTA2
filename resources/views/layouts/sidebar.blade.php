<nav x-data="{ open: false }" class="w-auto h-full w-2xl bg-gray-200 border-r-2 border-gray-400">
    ...
    <div class="flex-column justify-start">
        ...
        @php
            ...
            // Create array of button with details (including employer buttons)
            $buttonRoutes = [
            ...
            $roleButtons = array(
                ...
                'tutor' => $tutorButtons,
                'admin' => $adminButtons,
                'employer' => array_merge(['dashboard', 'view_learners', 'learner_progress', 'apprenticeship', 'archive_learners'], $employerButtons),
            );
        @endphp
