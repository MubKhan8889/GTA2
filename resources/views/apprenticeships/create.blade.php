...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
            <h1 class="text-2xl font-bold text-gray-700 mb-6">Create Apprenticeship</h1>
            ...
            <form action="{{ route('apprenticeships.store') }}" method="POST">
                @csrf
                <div class="space-y-4">
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="months" required class="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
